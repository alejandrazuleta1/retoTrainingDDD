...
public class UpdatedDataSensei extends DomainEvent {
    ...
    public UpdatedDataSensei(Name name, PersonId personId, Specialty specialty, MemberGit memberGit, List<Accomplishment> accomplishmentList) {
        super("Dojo.UpdatedDataSensei");
        this.name = name;
